...
import IntCourseManage from './IntCourseManage.vue';

export default {
  name: "TeacherDashboard",
  components: {
    ResourceManage, // 直接注册，不要重复声明
  ...
  data() {
    return {
      ...
      navItems: [    
        { key: 'int-course-manage', label: '智能课程管理', component: 'IntCourseManage' },
        { key: 'resource-manage', label: '教学实施工具', component: 'ResourceManage' }
      ],
      activeNav: null,
      showDropdown: false
    }
